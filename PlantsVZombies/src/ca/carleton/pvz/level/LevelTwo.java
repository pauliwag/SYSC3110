...
public class LevelTwo extends Level {
	...
	public void initWaves() {
		...
		Wave[] waves = {
				...
				new Wave(1, Difficulty.NORMAL, 2, 2, 0, 0, 0, 0),
				new Wave(2, Difficulty.NORMAL, 0, 0, 0, 1, 0, 0),
				new Wave(3, Difficulty.RAMPED, 0, 1, 2, 0, 0, 0),
				new Wave(4, Difficulty.RAMPED, 0, 0, 0, 1, 0, 0),
				new Wave(5, Difficulty.RAMPED, 0, 2, 1, 0, 0, 0),
				new Wave(6, Difficulty.RAMPED, 0, 0, 2, 1, 0, 0),
				new Wave(7, Difficulty.RAMPED, 2, 1, 0, 0, 0, 0),
				new Wave(8, Difficulty.SUPER_RAMPED, 0, 0, 0, 0, 4, 0),
				new Wave(9, Difficulty.RAMPED, 0, 0, 0, 0, 0, 1),
				new Wave(10, Difficulty.RAMPED, 0, 0, 0, 0, 0, 1)
